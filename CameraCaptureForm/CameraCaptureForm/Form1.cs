...
namespace CameraCaptureForm
{
    ...
    {
        // Declaring constants
        static string haarFaceFile = @"C:\Emgu\emgucv-windesktop 3.3.0.2824\opencv\data\haarcascades\haarcascade_frontalface_default.xml";
        static string haarEyeFile = @"C:\Emgu\emgucv-windesktop 3.3.0.2824\opencv\data\haarcascades\haarcascade_eye.xml";
